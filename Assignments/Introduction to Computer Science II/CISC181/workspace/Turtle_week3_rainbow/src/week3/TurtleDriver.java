...
public class TurtleDriver {
	...
	public void drive() {
        ...
        Turtle chainEnd = turtle;

        for (int i = 1; i < 20; i++) {
	        Turtle donatello = new Turtle(this);
	        donatello.setXY(0, -10 * i);
	        donatello.setColor(new Color(i * 12, 255 - i * 12, i * 6 + 128));
	        donatello.setWidth(10);
	        donatello.penDown();
	        
	        chainEnd.setNext(donatello);
	        chainEnd = donatello;
        }
	...
	public void rainbow(double size) {
		for (int i = 0; i < 10; i++) {
