...
public class Turtle {
    ...
    private Turtle next;//self-referential class
    ...
    public void setNext(Turtle next){
    	this.next=next;
    }
    ...
    public void addNinjaTurtle(TurtleDriver driver,Color color,int offsetY){
    	if(this.next!=null){
    		this.next.addNinjaTurtle(driver, color, offsetY);
    	}
    	else{
    		next=new Turtle(driver);
    		next.setColor(color);
    		next.setXY(x, y+offsetY);
    		next.penDown();
    	}
    }
}
