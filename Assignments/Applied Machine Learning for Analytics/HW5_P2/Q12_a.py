...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 16:15:16 2019
...
for ib in range(1,2):
    ...
    for line in inputf:
        ...
        timestamptext = int(data['year'][8:10]) # because the raw data is from one year, we have to look into day -- Dian
...
output_pickle_2 = open('LDA_2018_feature_name.pkl', 'wb')
...
output_pickle = open('LDA_2018.pkl', 'wb')
