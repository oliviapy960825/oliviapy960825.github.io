...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 22:49:22 2019
...
model = pickle.load(open('anti_vaccine.pkl', 'rb'))
feature_name =  pickle.load(open('anti_vaccine_feature_name.pkl', 'rb'))
...
days= []
vax=pd.read_json("anti-vaccine.json", lines=True)
#day=str(vax['created_at'][0])
#print(day[8:10])
for i in range(len(vax)):
    day=str(vax['created_at'][i])
