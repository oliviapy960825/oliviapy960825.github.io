...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 12:38:40 2019
...
word_list=vocab_nips.iloc[word_index,0]
#print(word_list)

word_doc_nips=docword_nips.iloc[:,0]
doc_kos=docword_kos.iloc[:,0]+1500
#print(doc_kos)
word_doc=word_doc_nips.append(doc_kos)
#print(word_doc)
word_index_kos=docword_kos.iloc[:,1]-1
word_list_kos=vocab_kos.iloc[word_index_kos,0]
word_list=word_list.append(word_list_kos)
#print(word_list)

word_doc_enron=docword_enron.iloc[:,0]
doc_enron=docword_enron.iloc[:,0]+4930
#print(doc_enron)
word_doc=word_doc.append(doc_enron)
#print(word_doc)
word_index_enron=docword_enron.iloc[:,1]-1
word_list_enron=vocab_enron.iloc[word_index_enron,0]
word_list=word_list.append(word_list_enron)
#print(word_list)

print(word_list)
matrix=pd.DataFrame()
matrix['doc']=word_doc
matrix['word']=word_list.values
print(matrix)

clean_train_reviews=matrix['word'].dropna()
clean_train_reviews = [x for x in clean_train_reviews if x != None]"""
