...
class hashMap {
	...
	hashNode **map;  // set initial values to NULL
...
public:
	...
	void addKeyValue(string k, string v); // adds a node  to the map at the correct index based on the key string, and then inserts the value into the value field of the hashNode
	...
	int collHash2(int i, int count); // getting index with collision method 2 (note – you may modify the parameters if you don’t need some/need more)
