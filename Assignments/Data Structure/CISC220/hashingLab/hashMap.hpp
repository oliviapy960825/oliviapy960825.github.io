...
public:
    ~hashMap(); // desctructor-deallocates the map and arrays
    ...
    int getIndex(string k, bool addKeyValue = false); /* uses calcHash and reHash to calculate and return the index of
    ...
    int collHash2(int i, int pw2); /* getting index with collision method 2 (note – you may modify the
    parameters if you don’t need some/need more) */
